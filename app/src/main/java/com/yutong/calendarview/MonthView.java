...
public abstract class MonthView extends BaseView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mLineCount; i++) {
            for (int j = 0; j < 7; j++) {
                ...
                draw(canvas, calendar, i, j, d, mLineCount);
                ++d;
            }
        }
     ...
     * @param d        d
     */
    private void draw(Canvas canvas, Calendar calendar, int i, int j, int d, int mLineCount) {
        mContext.getResources().getDimension(R.dimen.dimen_150px);
        if (mLineCount == 4) {
            //setItemHeight((int)mContext.getResources().getDimension(R.dimen.dimen_111px));
            setItemHeight(dipToPx(mContext, Constant.FOUR));
        }
        if (mLineCount == 5) {
            //setItemHeight((int)mContext.getResources().getDimension(R.dimen.dimen_87px));
            setItemHeight(dipToPx(mContext, Constant.FIVE));
        }
        if (mLineCount == 6) {
            //setItemHeight((int)mContext.getResources().getDimension(R.dimen.dimen_74px));
            setItemHeight(dipToPx(mContext, Constant.SIX));
        }
        // System.out.println((int)mContext.getResources().getDimension(R.dimen.dimen_111px)+"   "+(int)mContext.getResources().getDimension(R.dimen.dimen_89px)+(int)mContext.getResources().getDimension(R.dimen.dimen_74px));
        int x = j * mItemWidth;
        int y = i * mItemHeight;
        onLoopStart(x, y);
