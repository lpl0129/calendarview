...
public abstract class BaseView extends View implements View.OnClickListener, View.OnLongClickListener {
    ...
    private void initPaint(Context context) {
        ...
        mCurMonthTextPaint.setColor(0xff222222);
        ...
        mOtherMonthTextPaint.setColor(0xff222222);
        ...
        mSchemeTextPaint.setColor(0xff222222);
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        //this.mCurDayTextPaint.setColor(Color.WHITE);
       ...
       // this.mOtherMonthTextPaint.setColor(delegate.getOtherMonthTextColor());
        this.mCurMonthLunarTextPaint.setColor(getResources().getColor(R.color.month_lunar));
        ...
        this.mOtherMonthLunarTextPaint.setColor(getResources().getColor(R.color.month_lunar));
        ...
        this.mCurMonthLunarTextPaint.setTextSize(Constant.MONTHLUNAR);
        ...
        this.mOtherMonthLunarTextPaint.setTextSize(Constant.MONTHLUNAR);
        this.mSchemeLunarTextPaint.setTextSize(delegate.getLunarTextSize());

        this.mSelectedPaint.setStyle(Paint.Style.STROKE);
        this.mSelectedPaint.setColor(getResources().getColor(R.color.round));
